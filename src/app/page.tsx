      ...
      <ScrollArea className="flex-grow">
        <main className="container mx-auto p-4">
          {topLevelKeys.length > 0 ? (
            ...
            // Handle cases where jsonData is not an object with keys (e.g., it's an array or primitive)
            // Or when it's an empty object
             <Card className="my-4 shadow-lg">
                <CardHeader>
                    ...
                    {typeof jsonData !== 'object' || jsonData === null || Object.keys(jsonData).length === 0 && 
                        <CardDescription>The current JSON is not a non-empty object. Displaying root value.</CardDescription>
                    }
                </CardHeader>
                <CardContent>
                    <JsonTreeEditor
           ...
           <Card className="mt-8 mb-4">
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <li>AI-powered summarization and content enhancement (requires OpenAI API key).</li>
